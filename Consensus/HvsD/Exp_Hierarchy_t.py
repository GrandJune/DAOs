...
with open("Hierarchy_overall_performance_t124", 'wb') as out_file:
    pickle.dump(overall_across_para, out_file)
with open("Hierarchy_manager_performance_t124", 'wb') as out_file:
    pickle.dump(manager_across_para, out_file)
with open("Hierarchy_superior_performance_t124", 'wb') as out_file:
...
plt.legend()
plt.savefig("Hierarchy_t_overall_performance.jpg")
...
plt.ylabel('Performance')
plt.legend()
plt.savefig("Hierarchy_t_manager_performance.jpg")
...
plt.ylabel('Performance')
plt.legend()
plt.savefig("Hierarchy_t_superior_performance.jpg")
...
if __name__ == '__main__':
    t0 = time.time()
    m_list = [30, 60, 90]  # Christina's paper: 100
    s = 3
    t = 1
    n = 500
    search_round_list = [300, 600, 900]
    repetition_round = 200
    version = "Rushed"
    authority = False  # !!!!!!!!!!!!!!!! Without authority !!!!!!!!!!!!!!!!!!
    data_across_para = []
    for m, search_round in zip(m_list, search_round_list):
    ...
    with open("robust_performance_across_m", 'wb') as out_file:

...
plt.xticks(x)
# plt.yticks([])
plt.savefig("Diversity_across_s.png", bbox_inches='tight', pad_inches=0.01, transparent=True, dpi=1200)
plt.savefig(data_folder + r"\Diversity_across_s.png", bbox_inches='tight', pad_inches=0.01, transparent=True, dpi=1200)
plt.show()
# plt.clf()
# plt.close()

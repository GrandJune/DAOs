...
if __name__ == '__main__':
    ...
    with open("autonomy_percentile_10_across_m", 'wb') as out_file:
        pickle.dump(percentile_10_across_para, out_file)
    with open("autonomy_percentile_90_across_m", 'wb') as out_file:
    ...
    with open("autonomy_percentile_10_across_m_time", 'wb') as out_file:

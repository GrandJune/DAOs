...
if __name__ == '__main__':
    ...
    with open("hierarchy_performance_across_p1p2_6", 'wb') as out_file:
        pickle.dump(performance_across_p1p2, out_file)
    with open("superior_performance_across_p1p2_6", 'wb') as out_file:
        pickle.dump(superior_performance_across_p1p2, out_file)
    with open("hierarchy_diversity_across_p1p2_6", 'wb') as out_file:
        pickle.dump(diversity_across_p1p2, out_file)
    with open("hierarchy_variance_across_p1p2_6", 'wb') as out_file:

...
if __name__ == '__main__':
    ...
    if os.path.exists(r"dao_performance_0.9"):
        with open("dao_performance_0.9", 'rb') as infile:
    ...
    # remove time
    with open("dao_performance_0.9", 'wb') as out_file:
        pickle.dump(performance_final_across_incentive, out_file)
    with open("dao_consensus_performance_0.9", 'wb') as out_file:
        pickle.dump(consensus_final_across_incentive, out_file)
    with open("dao_diversity_0.9", 'wb') as out_file:
        pickle.dump(diversity_final_across_incentive, out_file)
    with open("dao_variance_0.9", 'wb') as out_file:
    ...
    print("active=0.9", time.strftime("%Y-%m-%d %H:%M:%S", time.gmtime(time.time())))  # Complete time

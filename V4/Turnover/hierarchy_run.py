...
if __name__ == '__main__':
    ...
    with open("hierarchy_percentile_10_across_turnover", 'wb') as out_file:
        pickle.dump(percentile_10_across_para, out_file)
    with open("hierarchy_percentile_90_across_turnover", 'wb') as out_file:
    ...
    with open("hierarchy_percentile_10_across_turnover_time", 'wb') as out_file:
        pickle.dump(percentile_10_across_para_time, out_file)
    with open("hierarchy_percentile_90_across_turnover_time", 'wb') as out_file:

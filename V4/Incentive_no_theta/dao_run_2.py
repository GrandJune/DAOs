...
def func(m=None, n=None, group_size=None, lr=None, incentive=None, inactive_rate=None,
        ...
        for inactive_rate in inactive_rate_list:
            ...
            for loop in range(repetition):
                ...
                p = mp.Process(target=func,
                               args=(m, n, group_size, lr, incentive, inactive_rate, search_loop, loop, return_dict, sema))
                jobs.append(p)
                p.start()
            for proc in jobs:
                proc.join()

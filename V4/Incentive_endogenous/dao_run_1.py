...
if __name__ == '__main__':
    ...
    index = 1
    while os.path.exists(r"dao_performance_1_{0}".format(index)):
        index += 1
    with open("dao_performance_1_{0}".format(index), 'wb') as out_file:
        pickle.dump(performance_final_across_sensitivity_incentive, out_file)
    with open("dao_consensus_performance_1_{0}".format(index), 'wb') as out_file:
        pickle.dump(consensus_final_across_sensitivity_incentive, out_file)
    with open("dao_diversity_1_{0}".format(index), 'wb') as out_file:
        pickle.dump(diversity_final_across_sensitivity_incentive, out_file)
    with open("dao_variance_1_{0}".format(index), 'wb') as out_file:

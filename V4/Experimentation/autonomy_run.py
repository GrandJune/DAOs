...
if __name__ == '__main__':
    ...
    file_index = 1
    performance_file_name = f"autonomy_performance_across_experimentation_{file_index}"
    ...
    with open("autonomy_performance_across_experimentation_{0}".format(file_index), 'wb') as out_file:
        pickle.dump(performance_across_para, out_file)
    with open("autonomy_diversity_across_experimentation_{0}".format(file_index), 'wb') as out_file:
        pickle.dump(diversity_across_para, out_file)
    with open("autonomy_variance_across_experimentation_{0}".format(file_index), 'wb') as out_file:

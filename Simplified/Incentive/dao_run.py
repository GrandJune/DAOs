...
def func(m=None, n=None, lr=None, asymmetry=None,
    ...
    if asymmetry == 0:
        ...
        token_list = [individual.token for individual in dao.individuals]
        ...
        for hyper_loop in range(hyper_iteration):
            ...
            for loop in range(repetition):
                ...
                p = mp.Process(target=func,
                               args=(m, n, lr, asymmetry, search_loop, loop, return_dict, sema))
                jobs.append(p)
                p.start()
            for proc in jobs:
                proc.join()
